...
useEffect(() => {
  fetchSyncedProducts().then(res => {
    ...
    const found = res.data.find(p => p.id == id); // `==` pra garantir que string/number bate
setProduto(found);
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white min-h-screen">
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="mt-4 space-y-2">
              <p className="text-lg text-gray-700">
                Descrição do produto (em breve). Aqui podemos incluir características detalhadas.
              </p>
          ...
          <button className="mt-8 px-6 py-3 bg-black text-white rounded hover:bg-gray-800 text-lg">
            Comprar agora
          </button>
        </div>
      </div>
